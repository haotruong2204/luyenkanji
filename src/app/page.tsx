...
import { KanjiByLevel } from "@/components/kanji-by-level";
  ...
  return (
    <>
      ...
      <div className="flex size-full flex-col md:ml-20">
        ...
        {/* MOBILE */}
        <div className="w-full grow overflow-y-auto md:hidden">
        ...
        {/* DESKTOP */}
        <div className="hidden w-[97%] grow overflow-x-hidden p-8 md:block">
          <div className="grid grid-cols-[2fr_3fr] gap-8">
            {/* LEFT COLUMN - Search & Draw */}
